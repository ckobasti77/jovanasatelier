...
const PANEL_COPY = {
  ...
  sr: {
    ...
    profilesTitle: "sa�?uvani profili",
    profilesDescription: "Primeni sa�?uvan profil da unapred popuni�� osnovne mere.",
    profilesPlaceholder: "Izaberi profil",
    profilesEmpty: "Kreiraj profil da ubrza�� budu�?e probe.",
