...
const PAGE_COPY = {
  ...
  sr: {
    ...
    title: "Profili mera",
    description:
      "Napravi profile za razli�?ite visine potpetica ili siluete. Primeni ih u konfiguratoru ili tokom proba.",
    add: "Novi profil",
    emptyTitle: "Jo�� nema profila",
    emptyBody: "Kreni tako �?to ��e�� kreirati profil sa svojim standardnim merama.",
    ...
    lastUpdated: (date: string) => `A�_urirano ${date}`,
    view: "Otvori profil",
  },
} as const;
